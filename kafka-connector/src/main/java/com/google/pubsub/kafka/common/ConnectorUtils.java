...
public class ConnectorUtils {
  ...
  public static final String CPS_CLOUD_REGION = "cps.cloudRegion";
  public static final String CPS_ZONE_ID = "cps.zoneId";
  public static final String CPS_LITE = "cps.lite";
