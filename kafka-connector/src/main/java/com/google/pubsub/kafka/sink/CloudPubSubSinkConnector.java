...
public class CloudPubSubSinkConnector extends SinkConnector {
  ...
  public static final long DEFAULT_MAX_BUFFER_BYTES = 1000000L;
  ...
  public ConfigDef config() {
    return new ConfigDef()
        ...
        .define(
            ConnectorUtils.CPS_LITE,
            Type.BOOLEAN,
            false,
            Importance.HIGH,
            "Define if it's Google PubSub Lite service.")
        .define(
            ConnectorUtils.CPS_CLOUD_REGION,
            Type.STRING,
            "",
            Importance.HIGH,
            "The region where the PubSub Lite topic is located.")
        .define(
            ConnectorUtils.CPS_ZONE_ID,
            Type.STRING,
            "",
            Importance.HIGH,
            "The zone where the PubSub Lite topic is located.")
        .define(
